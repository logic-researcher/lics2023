...
public class Inferencer {
	...
	public List<Formula> combination_A(AtomicConcept concept, List<Formula> formula_list, OWLOntology onto,
									   OWLReasoner reasoner, ThreadLocal<OWLReasoner> reasonerThreadLocal) // List has two elements, the result list after forgetting and the number of the usage of each rule
			throws Exception {
		...
		for (Formula formula : formula_list) { // Classifying the axioms
...
//			time++;
		...
		for (Formula pe_premise : positive_exists_premises) {
			...
			for(Formula nsa_premise :negative_star_and_premises){
				...
				if(reasoner == null){
					reasoner = reasonerThreadLocal.get();
				}
	...
	public List<Formula> combination_R(AtomicRole role, List<Formula> formula_list, OWLOntology onto,
									   OWLReasoner reasoner, ThreadLocal<OWLReasoner> reasonerThreadLocal)
			throws Exception {
